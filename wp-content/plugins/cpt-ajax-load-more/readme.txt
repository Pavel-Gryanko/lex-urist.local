...
CPT Ajax load more is the flexible solutions for WordPress to load only some of the posts and another posts will be load with infinite scroll or load more and you can create beautiful blog listing quickly.

If you are looking for large number of posts listing in single page then CPT Ajax load more is the right choice.

### Key Features

&#9989; CPT Ajax load more is the using WordPress standard query with the many parameters like Post Type, Post Status, Category Taxonomies and more.
...
Lightweight CPT Ajax load is very simple way to use, you just put short-code anywhere.
...
You can find [docs](https://plugins.blacktheme.net/cpt-ajax-load-more/docs/) and more details about CPT Ajax load more on [blacktheme.net](https://plugins.blacktheme.net/cpt-ajax-load-more/)
...
Yes, in the settings menu of the CPT Ajax load more plugin.

= Is the Ajax call secure? =
Yes, CPT Ajax load more uses the WordPress standard nonce to protect the URL to direct access and also admin user can set permission to allow custom post type and post status.
